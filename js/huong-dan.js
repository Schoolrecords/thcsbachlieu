...
(function () {
  ...
  { ten: 'Bắt đầu', ic: '🚪', muc: [
    ...
    { td: 'Đăng nhập lần đầu', ai: GV, tim: 'dang nhap gmail google tai khoan', nd: [
      { t: 'Hệ thống không có mật khẩu riêng. Thầy cô đăng nhập bằng chính hộp thư Gmail của nhà trường đã cấp.' },
      { b: [
        'Mở trang web của trường trên trình duyệt Chrome hoặc Cốc Cốc.',
      ...
      { c: '⚠ Đăng nhập xong mà thấy chữ “Chờ duyệt” thì tài khoản chưa được mở quyền. Thầy cô báo bộ phận quản trị, đừng đăng nhập lại nhiều lần vì không giải quyết được gì.' }
    ] },
    ...
    { td: 'Không đăng nhập được — làm gì', ai: GV, tim: 'loi khong dang nhap duoc cho duyet', nd: [
      { k: [['Màn hình báo gì', 'Nghĩa là', 'Thầy cô làm gì'], [
        ...
        ['Tài khoản không có trong danh sách', 'Đăng nhập bằng thư cá nhân', 'Đăng xuất Google rồi vào lại bằng thư nhà trường cấp'],
    ...
    { td: 'Sáu màn hình của hệ thống', ai: GV, tim: 'man hinh menu tong quan bo cuc', nd: [
      { k: [['Màn hình', 'Dùng để làm gì'], [
        ...
        ['Kiểm định chất lượng', 'Tự đánh giá theo tiêu chí, kết xuất báo cáo tự đánh giá'],
  ...
  { ten: 'Việc của giáo viên', ic: '👩‍🏫', muc: [
    ...
    { td: 'Tìm một minh chứng và mở thư mục Drive của nó', ai: GV, tim: 'tim minh chung ma ho so drive thu muc', nd: [
      ...
      { t: 'Ô tìm kiếm nhận <b>cả mã mới lẫn mã cũ</b>. Thầy cô còn quen mã cũ trên bìa hồ sơ giấy thì cứ gõ mã cũ.' },
    ...
    { td: 'Lập bản cam kết của giáo viên — Phụ lục 15', ai: GV, tim: 'cam ket giao vien phu luc 15 chuan dau ra', nd: [
      ...
      { t: 'Thầy cô chỉ thấy và sửa được các lớp, môn mình được phân công. Không thấy lớp mình dạy thì báo bộ phận chuyên môn kiểm lại bảng phân công.' }
    ] },
    ...
    { td: 'Xem và in danh sách lớp', ai: GV, tim: 'in danh sach lop hoc sinh si so', nd: [
      ...
      { c: '⚠ Ô chọn năm học liệt kê mọi năm còn dữ liệu. Xem năm cũ xong nhớ chuyển lại năm hiện hành, kẻo lấy nhầm sĩ số năm trước làm số của năm nay.' }
    ] }
  ...
  { ten: 'Việc của tổ trưởng chuyên môn', ic: '📋', muc: [
    ...
    { td: 'Nhập số liệu bằng Excel', ai: TT, tim: 'excel tai mau nhap so lieu phu luc', nd: [
      ...
      { b: [
        ...
        'Mở tệp, điền các cột Khối 6 đến Khối 9. Trang tính <b>Hướng dẫn</b> ở tệp ghi rõ cách ghi từng dạng giá trị.',
      ...
      { t: 'Thầy cô có thể chèn thêm dòng ghi chú, đổi thứ tự dòng, thêm cột riêng — hệ thống vẫn đọc đúng.' }
    ] },
  ...
  { ten: 'Việc của quản trị hệ thống', ic: '⚙', muc: [
    ...
    { td: 'Bảy tab của cửa sổ Quản trị', ai: QT, tim: 'quan tri he thong tab tong quan nguoi dung nhat ky', nd: [
    ...
    { td: 'Mời người mới và phân quyền', ai: QT, tim: 'moi tai khoan phan quyen vai tro nguoi dung', nd: [
      ...
      { k: [['Vai trò', 'Làm được gì'], [
        ['Giáo viên', 'Xem lớp mình dạy, nộp minh chứng, lập cam kết Phụ lục 15'],
        ['Tổ trưởng chuyên môn', 'Thêm: nhập số liệu Excel, tính lại 33 chỉ tiêu'],
        ['Ban giám hiệu', 'Toàn bộ nghiệp vụ: nạp sổ VnEdu, tịnh tiến lên lớp, kết xuất phụ lục'],
  ...
  /* Nội dung do chính dự án viết nên cho phép thẻ <b>. Chặn dấu ngoặc nhọn
     trước, rồi mở lại đúng một cặp thẻ — không mở cửa cho thẻ nào khác. */
  function dam(s) {
    return chan(s).replace(/&lt;b&gt;/g, '<b>').replace(/&lt;\/b&gt;/g, '</b>');
  }
  function khongDau(s) {
